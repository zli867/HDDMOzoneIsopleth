...
baseNOx = 395.748;
baseVOC = 401.412;
% Find the data position in excel file
for k = 1: 24
...
for siteNum = 1: 24
	...
	O3 = a0 + a1 * NOx + a2 * VOC + a3 * NOx.^2 + a4 * NOx .* VOC;
	...
	hold off;
	% save figures
	% saveas(gcf, strcat('/Users/zongrunli/Desktop/CMAQ-DDM/figures/', siteName{siteNum}, ' QReducemodel.jpg'))
end